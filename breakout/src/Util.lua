...
--[[
    Function to get the powerUp sprites.
    Relatively easy, as all are the same shape and size,
    and at a consistent point in the texture
]]
function GenerateQuadsPowerUps(atlas)
    return table.slice(GenerateQuads(atlas, 16, 16), 147, 154)
end