...
-- Get the not hit sound effect from AM2R if you can find it.
...
--[[
    ...
    changing its color otherwise. Also returns score for breaking the brick
]]
function Brick:hit()

    --first check if it's a blocked brick, and handle that situation
    ...
    -- if we're on the sixth color, break the brick
