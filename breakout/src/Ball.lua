...
--! Insstead of limiting speed here, maybe limit it at places we're changing it
function Ball:update(dt)
    self.dx = math.max(math.min(230, self.dx), -230)
    self.dy = math.max(math.min(170, self.dy), -170)
